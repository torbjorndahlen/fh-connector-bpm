...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    env: {
      ...
      local: {
        BPM_PROCESS_DEPLOYMENTID: 'mobile:request-processing:1.0',
        BPM_PROCESS_PROCESSDEFID: 'mobile.request-processing',
        BPM_AUTH_USERNAME:'bpmsAdmin',
        BPM_AUTH_PASSWORD:'r0tm0s!!',
        BPM_URI_HOSTNAME:'localhost',
        BPM_URI_PORT:'8080',
